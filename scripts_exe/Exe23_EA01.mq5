...
//+------------------------------------------------------------------+
//--- inputs for expert
input string Expert_Title         ="Exe23_EA01"; // Document name
ulong        Expert_MagicNumber   =28602;        //
...
input double Signal_AC_Weight     =1.0;          // Accelerator Oscillator M1 Weight [0...1.0]
//--- inputs for money
